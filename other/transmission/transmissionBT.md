...
transmission-remote --auth 用户名:密码 -l
...
transmission-remote --auth 用户名:密码 -a 2.torrent


transmission-remote --auth 用户名:密码 -a http://www.test.me/abc.torrent
...
for name in `ls`;
 ...
 do transmission-remote --auth opengl:aaa -a $name && rm $name;
